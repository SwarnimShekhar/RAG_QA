...
if uploaded_file is not None:
    ...
    if not pinecone.has_index('rag-qa'):
        ...
        with st.spinner("Creating Pinecone index..."):
            ...
            st.write("Index 'rag-qa' created.")
    else:
        st.write("Index 'rag-qa' already exists.")

    # Connect to the existing index
    index = pinecone.Index("rag-qa")
